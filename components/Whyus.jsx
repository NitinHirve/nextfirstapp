...
import stylesWhyus from '../styles/whyus.module.css';
...
const Whyus = () => {
    return (
        <>
            ...
            <img className={stylesWhyus.circles2} src="/svgani/circle2.svg" style={{ width: '250px',position:'absolute',right:'100px',top:'-50px'  }} />
                ...
                <img className={stylesWhyus.circles3} src="/svgani/circle3.svg" style={{ width: '250px',position:'absolute',bottom:'0px'  }} />
            </Box>
        </>
    )
}
