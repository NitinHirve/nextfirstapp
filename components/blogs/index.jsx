                        ...
                        <Box sx={{ margin: { sm: '50px 80px 50px 83px', xs: '30px 10px' }, display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
                            {
                                allCategories.map((category) => (<>
                                    <button style={{ border: currentBlogCategory === category ? '1px solid #86cef7' : '1px solid #1e8be1', backgroundColor: currentBlogCategory === category ? '#86cef7' : '#1e8be1', color: 'white', margin: 0 }} value={category} onClick={handleBlogCategory} className={`${stylesServices.btn} ${stylesServices.fourth}`}>{category}</button>
                                </>))
                            }
                        </Box>
                    </>
