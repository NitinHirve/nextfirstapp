            ...
            <Box sx={{ display: 'flex' }}>
                ...
                sx={{ height: '250px', width: '600px', boxShadow: 3, backgroundColor: '#fff', marginLeft: '150px', zIndex: 2 }}>
                    <Stack direction="row" justifyContent="space-around">
                        <img src='/images/TrustedBy/onTab3logo.png' style={{ width: '130px' }} />
                        <img src='/images/TrustedBy/CDlogo.png' style={{ width: '130px' }} />
                        <img src='/images/TrustedBy/AtosLogo.png' style={{ width: '130px' }} />
                    </Stack>
                    <Stack direction="row" justifyContent="space-around" sx={{ marginTop: '-30px', padding: '0px 80px 0 80px' }}>
                        <img src='/images/TrustedBy/poyntLogo2.png' style={{ width: '70px', height: '90px', marginTop: '20px' }} />
                        <img src='/images/TrustedBy/ItzCash.png' style={{ width: '130px' }} />
                    </Stack>
                </Box>
